...
export const translations = {
  en: {
    ...
    tagUpdateFailed: "Failed to update proxy usage tag: {error}",
  ...
  pt: {
    ...
    tagUpdateFailed: "Falha ao atualizar tag de uso: {error}",
  ...
  es: {
    ...
    reuseProxy: "Reutilizando proxy {host}:{port} ({usage}/3)",
    tagUpdateFailed: "Error al actualizar etiqueta de uso: {error}",
